...
corpus_paths = [
    '../corpus_tfrecord/corpus.%s.tfrecord' % i for i in range(1)
]
# 其他配置
sequence_length = 512
batch_size = 4096
batch_size = 128
config_path = '/search/odin/guobk/streaming/vpa/pretrained_model/chinese_L-12_H-768_A-12/bert_config.json'
